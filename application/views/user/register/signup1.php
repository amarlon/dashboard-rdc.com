...
<head>
  ...
  <body class="text-center" >
    ...
    <form class="form-signin border paddinlr10 "  style="background: white" action="<?= base_url()?><?php echo $this->uri->segment(1)?>/register2"  method="POST">
      ...
      <h3 class="h3 mb-3 font-weight-normal font-connexion2" style='text-transform: uppercase;'> -- <?php echo $this->lang->line('bcc_step');?> 2 --</h3>
      
      <input type="hidden" name="username" class="form-control" value="<?php echo $username ;?>" autofocus >
      <input type="hidden"  class="form-control" name="email" value="<?php echo $email ;?>" autofocus><br>
       <!--tous ce qui c'est fait voir-->
          ...
          <li class="nav-item dropup " >
           <a class="nav-link dropdown-toggle"  id="dropdown10" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false" style="cursor: pointer">
            ...
            <div class="dropdown-menu violet " aria-labelledby="dropdown10"  style=" opacity: 0.8">
             <a style=" color: white" class="dropdown-item" href="<?php echo base_url()?>RU/register1">Русский</a>
              <a style=" color: white" class="dropdown-item " href="<?php echo base_url()?>EN/register1">English</a>
              <a  style=" color: white" class="dropdown-item" href="<?php echo base_url()?>FR/register1">Français</a>
              <a style=" color: white" class="dropdown-item" href="<?php echo base_url()?>SP/register1">Español</a>
              <a style=" color: white" class="dropdown-item" href="<?php echo base_url()?>POR/register1">Português</a>
            </div>
          </li>
        </ul>
      </div>
