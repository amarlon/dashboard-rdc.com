...
<head>
  ...
  <body class="text-center" >
    ...
    <form class="form-signin border paddinlr10 "  style="background: white" action="<?= base_url()?><?php echo $this->uri->segment(1)?>/register3"  method="POST">
      ...
      <h3 class="h3 mb-3 font-weight-normal font-connexion2" style='text-transform: uppercase;'> -- <?php echo $this->lang->line('bcc_step');?> 3 --</h3>
      ...
      <input type="hidden"  class="form-control" name="password_confirm" value="<?php echo $password_confirm ;?>" autofocus>      <!--tous ce qui c'est fait voir-->
      ...
      <select id="inputState" class="form-control" required style="font-size: 13px" name="gender">
      ...
      <br>
       <div class="alert alert-info" role="alert">
           <?php echo $this->lang->line('bcc_telephone_condition');?> 
      </div>
       <input type="tel" class="form-control" name="telephone" pattern="^((\+\d{1,3}(-| )?\(?\d\)?(-| )?\d{1,5})|(\(?\d{2,6}\)?))(-| )?(\d{3,4})(-| )?(\d{4})(( x| ext)\d{1,5}){0,1}$" placeholder="(890) 000 0000" ><br>
        ...
        <ul class="navbar-nav mr-auto ">
          ...
          <li class="nav-item dropup " >
            ...
            <div class="dropdown-menu violet " aria-labelledby="dropdown10"  style=" opacity: 0.8">
             <a style=" color: white" class="dropdown-item" href="<?php echo base_url()?>RU/register2">Русский</a>
              <a style=" color: white" class="dropdown-item " href="<?php echo base_url()?>EN/register2">English</a>
              <a  style=" color: white" class="dropdown-item" href="<?php echo base_url()?>FR/register2">Français</a>
              <a style=" color: white" class="dropdown-item" href="<?php echo base_url()?>SP/register2">Español</a>
              <a style=" color: white" class="dropdown-item" href="<?php echo base_url()?>POR/register2">Português</a>
            </div>
          </li>
        </ul>
      </div>
