<div id="home" class="view jarallax" data-jarallax='{"speed": 0.2}' style="background-attachment:fixed; background-image:url('<?= base_url("assets/images/service.png")?>'), url('<?= base_url("assets/images/realisa2.jpg")?>');">
      <div class="full-bg-img">
        <div class="container flex-center">
          <div class="row smooth-scroll">
            <div class="col-xs-12 col-md-12 " style="background: #384e5199;">
              <div class="wow fadeInUp text-center " style="padding: 10px">
                <h3 class="display-4 font-bold white-text mb-3"><b>Nos offres</b></h3>
                <h4 class=" mt-3 white-text" style=" text-align: initial; ">- Solutions applicatives<br>
                  - Réseaux et sécurité informatique<br>
                  - Hébergements des sites web<br>
                  - Infographies<br>
                - Assistances et formations</h4>
              </div>
            </div>
          </div>
        </div>
 ...
 <!-- First container -->
    <div id="app" class=" container-fluid" style="margin-top: 0px;width: 100%; min-height: 621.245px;">
...
" >
        <!--Secion heading-->
        <div class="full-b-img" style="margin:0;">
                <div class="container flex-center">
